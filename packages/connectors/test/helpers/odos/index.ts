...
import { getOdosSwapData } from '../../../src/odos'
...
export async function loadOrGetOdosSwapData(
  chainId: number,
  sender: Contract,
  tokenIn: Contract,
  tokenOut: Contract,
  ...
  const data = await getOdosSwapData(chainId, sender, tokenIn, tokenOut, amountIn, slippage)
