...
import { itBehavesLikeBalancerV2Connector } from './BalancerV2Connector.behavior'
...
describe('BalancerV2Connector', () => {
  ...
  before('create balancer v2 connector', async function () {
    this.connector = await deploy('BalancerV2Connector', [BALANCER_V2_VAULT])
  })
