...
<p align="center">
  <a href="https://badge.fury.io/js/@mimic-fi%2Fv3-connectors">
    <img src="https://badge.fury.io/js/@mimic-fi%2Fv3-connectors.svg" alt="NPM">
  </a>
  <a href="https://github.com/mimic-fi/v3-core/actions/workflows/ci-connectors.yml">
    <img src="https://github.com/mimic-fi/v3-core/actions/workflows/ci-connectors.yml/badge.svg" alt="CI Connectors">
  </a>
...
Connectors play a crucial role in the Mimic protocol, offering users the ability to interface with external DeFi 
protocols and extend the functionality of their Smart Vaults. These connectors are designed as Solidity libraries, 
providing a modular and flexible approach to integrating with various protocols.
...
$ cd v3-core/packages/connectors
