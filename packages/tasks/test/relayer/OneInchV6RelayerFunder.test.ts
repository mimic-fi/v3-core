...
describe('OneInchV6RelayerFunder', () => {
  ...
  before('deploy connector', async () => {
    connector = await deploy('OneInchV6ConnectorMock')
  ...
  beforeEach('deploy task', async () => {
    ...
    task = await deployProxy(
      ...
      'initializeOneInchV6RelayerFunder'
    )
  })
  ...
  describe('relayer funder', () => {
    ...
    itBehavesLikeBaseRelayerFundTask('1INCH_V6_SWAPPER')
  })

  describe('1inch v6 swapper', () => {
