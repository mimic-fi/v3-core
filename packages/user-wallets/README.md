...
<p align="center">
  <a href="https://badge.fury.io/js/@mimic-fi%2Fv3-user-wallets">
    <img src="https://badge.fury.io/js/@mimic-fi%2Fv3-user-wallets.svg" alt="NPM">
  </a>
  <a href="https://github.com/mimic-fi/v3-core/actions/workflows/ci-user-wallets.yml">
    <img src="https://github.com/mimic-fi/v3-core/actions/workflows/ci-user-wallets.yml/badge.svg" alt="CI User Wallets">
  </a>
...
These component of the Mimic protocol is responsible for deploying different instances for each
user. It provides a standardized and efficient approach to deploying wallets.
...
$ cd v3-core/packages/user-wallets
